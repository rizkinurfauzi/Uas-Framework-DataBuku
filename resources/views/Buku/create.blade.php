    ...
    <div class="container mt-3">
        <form action="{{route('buku.store')}} " method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="judulBuku" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Judul Buku">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1" class="font-weight-bold">Penulis</label>
              <input type="text" name="penulis" class="form-control" id="exampleInputPassword1" placeholder="Penulis">
            </div>
            <div class="form-group">
